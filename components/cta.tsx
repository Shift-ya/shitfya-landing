        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <p className="max-w-md text-pretty text-base leading-relaxed text-muted-foreground">
              Contanos sobre tu proyecto. Responderemos dentro de 24 horas con una evaluación sincera y un camino a seguir.
            </p>
            ...
            >
              WhatsApp
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="16" height="24">
